...
//   const movie = dataMovies.find((movie) => movie.idMovie === idMovie);
//   console.log(dataMovies, "o");
...
//           <h1 className="text-xl text-slate-700 font-semibold">Edit Movie</h1>
...
//               defaultValue={movie.category.join(", ")}
//             />
//             <p
//               className={`${
...
//               // defaultValue={movie.timeMovie.join(", ")}
//               className="hidden"
//             />
//             <p
//               className={`${
